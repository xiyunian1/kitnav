...
export const PPT_STYLE_PRESETS: PptStylePreset[] = [
  {
    id: "match-template",
    label: "按模板风格",
    description: "优先跟随上传或链接导入的 PPT 模板风格。",
    prompt:
      "优先按照用户上传或链接导入的 PPT 模板来确定视觉风格：保留模板的配色、字体气质、背景、主装饰、卡片样式、阴影、页眉页脚、空间比例和页面节奏；生成内容时只替换与当前主题无关的文字、图片占位和示例数据，不要从空白页重新设计。如果存在 template_refs/template-map.md 或模板底稿 SVG，必须以模板底稿为视觉基础。若没有可用模板，再退回为清晰稳重的中文商务演示风格。",
  },
  {
    id: "general",
    label: "通用演示",
